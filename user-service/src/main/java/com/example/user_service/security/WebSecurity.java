...
public class WebSecurity {
    ...
    public WebSecurity(Environment env, UserController userController, BCryptPasswordEncoder bCryptPasswordEncoder) {
        this.env = env;
    ...
    protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        authenticationManagerBuilder.userDetailsService(userController).passwordEncoder(bCryptPasswordEncoder);
    ...
    private AuthenticationFilterNew getAuthenticationFilter(AuthenticationManager authenticationManager) throws Exception {
        return new AuthenticationFilterNew(authenticationManager, userController, env);
    }
